              ...
              {item?.code &&
                ...
                item?.title && (
                  ...
                  >
                    ...
                    />
                    <h4 className="text-white font-semibold text-base mt-2">
                      {item?.discount}
                    </h4>
                    <button
                      onClick={() => handleOpenModal(item)}
                      className="cursor-pointer gettouchcoupon-btn bg-teal-500 hover:bg-teal-600 text-white font-medium text-[13px] px-4 py-2 rounded self-center"
                    >
                      {" "}
                      GET THIS COUPON
                    </button>
